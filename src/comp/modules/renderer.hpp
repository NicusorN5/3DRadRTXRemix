...
namespace comp
{
	...
	public:
		...
		// RT0 size, filled from SetRenderTarget so draws do not GetRenderTarget.
		static void note_render_target(IDirect3DDevice9* dev, DWORD index, IDirect3DSurface9* rt);
		static void invalidate_render_target_cache();
